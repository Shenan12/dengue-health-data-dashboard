...
- **Interactive Trends** allows users to explore weekly dengue trajectories for individual districts using a dropdown selector, with a zoomable range slider for fine-grained time navigation.
...
- **Map by Year** visualizes the geographic distribution of annual dengue cases across Sri Lanka.
- **Annual Case Matrix** A heatmap of how the dengue cases spread across the years in Sri Lanka.
