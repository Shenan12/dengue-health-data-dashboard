...
list(
  title = "Serotypes Identified (As of 2017)",
  icon  = "virus2",
  color = "secondary",
...
- **District Explorer** allows users to explore weekly dengue trends for individual districts using an interactive selector and time range slider.
- **Spatial Distribution** visualizes the geographic distribution of annual dengue cases and a heatmap of district-level case patterns over time.
