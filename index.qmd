...
```{r}
#| content: valuebox
#| title: "Highest Weekly Reported Case Count"
...
```{r}
#| content: valuebox
#| title: "Week with Highest Reported Cases"
list(
  icon  = "calendar-week",
  color = "info",
  value = peak$epi_week
...
```{r}
#| title: "Annual Reported Cases — Top 10 Highest-Burden Districts"
#| message: false
#| warning: false
...
```{r}
#| title: "STL Decomposition — National Reported Weekly Cases"
#| message: false
#| warning: false
