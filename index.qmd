...
p_nat <- plot_ly(sl_total, x = ~start.date, y = ~cases, type = 'scatter', mode = 'lines',
                 ...
                 hoverinfo = "text") |>
  layout(
    xaxis = list(title = "Timeline (Epi Weeks)", tickformat = "%G - Week %V"),
...
- Talagala T (2024). *ceylon: An R package for plotting the maps of Sri Lanka*. arXiv:2401.02467. <https://arxiv.org/abs/2401.02467>
